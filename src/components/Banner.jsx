    ...
    <section className='min-h-[85vh] lg:min-h-[78vh] flex items-center' id='home'>
      <div className='container mx-auto'>
        <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12'>
          ...
          className='text-[55px] font-bold leading-[0.8] lg:text-[110px]'>SUJAN <span>L</span></motion.h1>
            <motion.div variants={fadeIn('up', 0.3)} 
            initial='hidden' 
            whileInView={'show'} 
            viewport={{ once: false, amount: 0.7 }} className='mb-6 lg:
          ...
          <motion.p variants={fadeIn('up', 0.5)} 
            ...
            initial='hidden' 
            whileInView={'show'} 
            viewport={{ once: false, amount: 0.7 }} className='flex max-w-max gap-x-6 items-center mb-12 mx-auto lg:mx-0'><button className='btn btn-lg'>Get Resume</button>
